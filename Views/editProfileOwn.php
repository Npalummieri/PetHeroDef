    ...
    <div class="container">
        ...
        <form action="<?php echo FRONT_ROOT."Owner/updateOwner" ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control" id="email" name="email" value="<?php echo $infoOwner->getEmail(); ?>">
            </div>
            <div class="form-group">
                <label for="bio">Bio:</label>
                <textarea class="form-control" id="bio" name="bio"><?php echo "asdasdasd" ?></textarea>
            </div>
